...
ASSET_DOWNLOAD_URL = "https://github.com/Plecost/plecost-db/releases/download/db-base/plecost.db"
...
FAKE_INDEX = {
    ...
    "patches": [
        {
            "date": "2026-04-11",
            "url": "https://github.com/Plecost/plecost-db/releases/download/db-patches/patch-2026-04-11.json",
            "sha256": "def456",
        }
    ],
}
...
async def test_download_patch_verifies_sha256():
    ...
    sha256 = hashlib.sha256(content).hexdigest()
    patch_url = "https://github.com/Plecost/plecost-db/releases/download/db-patches/patch-2026-04-11.json"
